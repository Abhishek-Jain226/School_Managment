...
public class VehicleOwnerController {
    ...
    public ResponseEntity<ApiResponse> getOwnerDashboard(@PathVariable Integer ownerId) {
        return ResponseEntity.ok(vehicleOwnerService.getVehicleOwnerDashboard(ownerId));
    }
